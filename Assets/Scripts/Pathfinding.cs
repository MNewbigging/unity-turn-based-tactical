...
public class Pathfinding : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    if (Instance != null)
    {
      Debug.LogError($"Found more than one Pathfinding: {transform} - {Instance}");
      Destroy(gameObject);
      return;
    }
    Instance = this;
  ...
  public List<GridPosition> FindPath(GridPosition startGridPosition, GridPosition endGridPosition)
  {
    ...
    // Manually calculate for start node
  ...
  private List<PathNode> GetNeighbourList(PathNode currentNode)
  {
    ...
    // Check for valid neighbours to left
    ...
    // Check for valid neighbours to right
